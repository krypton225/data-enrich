const HamburgerButton = ({ getMdScreenState, onClickHandler }) => {
        return (
                <button type="button" className={`w-[1.8rem] h-[1rem] rounded-sm absolute right-5 top-1/2 -translate-y-1/2 z-[99999] md:hidden inline-flex flex-col justify-between items-center brightness-200 cursor-pointer ${getMdScreenState ? "rotate-[360deg]" : "rotate-0"} 
